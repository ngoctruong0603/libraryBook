/*!
 * jQuery JavaScript Libraryrary v3.3.1 -ajax,-ajax/jsonp,-ajax/load,-ajax/parseXML,-ajax/script,-ajax/var/location,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl,-event/ajax,-effects,-effects/Tween,-effects/animatedSelector
 * https://jquery.com/
 *
 * Includes Sizzle.js
 * https://sizzlejs.com/
...
(function (global, factory) {
  ...
  var Sizzle =
    ...
    (function (window) {
      var i,
        ...
        matchExpr = {
          ...
          // For use in Libraryraries implementing .is()
	...
	---------------------------------------------------------------------- */
        ...
        if ((support.qsa = rnative.test(document.querySelectorAll))) {
          ...
          assert(function (el) {
            ...
            // https://msdn.microsoft.com/en-us/Libraryrary/ie/hh465388.aspx#attribute_section
	...
	---------------------------------------------------------------------- */
      ...
      // https://msdn.microsoft.com/en-us/Libraryrary/ms536429%28VS.85%29.aspx
      if (
        !assert(function (el) {
   ...
   * Props to Dean Edwards' addEvent Libraryrary for many of the ideas.
   */
  jQuery.event = {
    global: {},
  ...
  // Note that for maximum portability, Libraryraries that are not jQuery should
  // declare themselves as anonymous modules, and avoid setting a global if an
  // AMD loader is present. jQuery is a special case. For more information, see
  // https://github.com/jrburke/requirejs/wiki/Updating-existing-Libraryraries#wiki-anon
