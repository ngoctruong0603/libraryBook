/*!
 * jQuery JavaScript Libraryrary v1.12.4
 * http://jquery.com/
 *
 * Includes Sizzle.js
 * http://sizzlejs.com/
...
(function (global, factory) {
  ...
  // Support: Firefox 18+
  // Can't be in strict mode, several Librarys including ASP.NET trace
  ...
  var Sizzle =
	...
	---------------------------------------------------------------------- */
        ...
        if ((support.qsa = rnative.test(document.querySelectorAll))) {
          ...
          assert(function (div) {
            ...
            // http://msdn.microsoft.com/en-us/Libraryrary/ie/hh465388.aspx#attribute_section
	...
	---------------------------------------------------------------------- */
      ...
      // http://msdn.microsoft.com/en-us/Libraryrary/ms536429%28VS.85%29.aspx
      if (
        !assert(function (div) {
    ...
    window.ActiveXObject !== undefined
      ? // Support: IE6-IE8
        function () {
          ...
          // See http://msdn.microsoft.com/en-us/Libraryrary/ie/ms536648(v=vs.85).aspx
